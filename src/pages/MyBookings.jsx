...
const MyBookings = () => {
    ...
    const fetchBookings = async () => {
      try {
        const response = await fetch(
          `https://hotel-booking-server-plum-five.vercel.app/bookings/${user.uid}`
        );
  ...
  const handleDateUpdate = async () => {
    try {
      const response = await fetch(
        `https://hotel-booking-server-plum-five.vercel.app/bookings/${selectedBooking._id}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleReviewSubmit = async () => {
    ...
    try {
      const response = await fetch("https://hotel-booking-server-plum-five.vercel.app/reviews", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
